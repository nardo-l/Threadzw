...
const FAQS: FAQItem[] = [
  { q: 'How does ThreadZW pricing work?', a: 'ThreadZW provides a limited free trial allowing merchants to launch their storefront completely free with up to 9 product listings and WhatsApp ordering, with zero recurring subscription fees.' },
