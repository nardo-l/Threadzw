...
const FAQS: FAQItem[] = [
  { q: 'How long does the free trial last?', a: 'All ThreadZW stores receive a 14-day full-access trial period when created. After the trial, you can subscribe to our Pro Merchant Plan for just $2.99/month to continue selling.' },
