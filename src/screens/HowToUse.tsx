      ...
      <header className="p-8 pt-12 flex flex-col gap-6 shrink-0 z-10 sticky top-0 bg-black/80 backdrop-blur-xl border-b border-white/5">
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="w-full h-12 bg-[#111] border border-[#222] rounded-full pl-12 pr-6 text-sm text-white placeholder-[#444] focus:border-[#25D366] transition-all outline-none"
          />
        </div>
      </header>
          ...
          {loading ? (
            ...
            filteredGuides.map((guide, idx) => (
              <motion.div
                ...
                className="group relative bg-[#111] border border-[#222] p-5 rounded-[24px] hover:border-[#25D366]/20 transition-all active:scale-[0.98]"
              >
                <div className="flex items-start justify-between">
                  <div className="flex gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-[#25D366]/10 flex items-center justify-center text-[#25D366] group-hover:bg-[#25D366] group-hover:text-black transition-all">
                    ...
                    <div className="flex flex-col gap-1">
                      <h3 className="text-[17px] font-bold text-white group-hover:text-[#25D366] transition-colors">{guide.title}</h3>
