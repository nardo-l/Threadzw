...
export const LandingPage: React.FC<LandingPageProps> = ({ onStartFree }) => {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-[#ffffff] flex flex-col selection:bg-[#C6FF00] selection:text-black font-sans antialiased overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-black/80 backdrop-blur-md border-b border-zinc-900/60 py-4">
        <div className="max-w-[480px] mx-auto px-4 flex items-center justify-between">
          ...
          <span 
            onClick={() => navigate('/')} 
            className="text-xl font-black tracking-tighter text-[#C6FF00] hover:opacity-90 transition-opacity cursor-pointer select-none flex items-center gap-1.5"
          >
            <span className="w-2.5 h-2.5 bg-[#C6FF00] rounded-sm inline-block animate-pulse" />
            ThreadZW
          </span>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={onStartFree}
              className="bg-[#C6FF00] hover:opacity-90 active:scale-[0.98] text-black text-xs font-black px-4.5 py-2.5 rounded-full transition-all cursor-pointer shadow-md shadow-[#C6FF00]/10 tracking-wide uppercase"
            >
              Start Free
            </button>
          </div>
      ...
      <section className="px-4 pt-10 pb-12 max-w-[480px] mx-auto w-full flex flex-col items-center">
        ...
        >
          Turn your WhatsApp business into a <span className="text-[#C6FF00] font-black">real online shop</span> in 5 minutes.
        </motion.h1>
        ...
        >
          <button
            onClick={onStartFree}
            className="w-full py-4.5 bg-[#C6FF00] hover:bg-[#b0e300] active:scale-[0.98] text-black font-black text-sm uppercase rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#C6FF00]/15 cursor-pointer font-sans"
          >
      ...
      <section className="bg-zinc-950/40 border-y border-zinc-900/50 py-12 overflow-hidden">
        <div className="max-w-[480px] mx-auto px-4 mb-6">
          <span className="font-mono text-[9px] text-[#C6FF00] uppercase tracking-[0.25em] font-bold block mb-1">AUDIENCE</span>
      ...
      <section className="px-4 py-16 max-w-[480px] mx-auto w-full">
        <div className="mb-10 text-center">
          <span className="font-mono text-[9px] text-[#C6FF00] uppercase tracking-[0.25em] font-bold block mb-1.5">PROCESS</span>
          ...
          {steps.map((st, i) => (
            ...
            >
              ...
              <div className="space-y-1">
                <span className="font-mono text-[9px] text-[#C6FF00] uppercase tracking-wider font-bold block">{st.step}</span>
      ...
      <section className="bg-zinc-950/40 border-y border-zinc-900/50 py-16 px-4">
        <div className="max-w-[480px] mx-auto w-full">
          <div className="text-center mb-10">
            <span className="font-mono text-[9px] text-[#C6FF00] uppercase tracking-[0.25em] font-bold block mb-1.5">PRICING</span>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-zinc-900/60 border-2 border-[#C6FF00]/20 rounded-3xl p-6 shadow-2xl relative overflow-hidden"
          >
            {/* Pop badge */}
            <div className="absolute top-0 right-0 bg-[#C6FF00] text-black text-[9px] font-black uppercase px-3.5 py-1.5 rounded-bl-xl tracking-wider select-none">
              Most Popular
            </div>

            <span className="font-mono text-[10px] text-[#C6FF00] uppercase tracking-wider font-black block mb-1">PRO PLAN</span>
            ...
            <div className="inline-block bg-[#C6FF00]/10 border border-[#C6FF00]/15 rounded-lg px-3 py-1 text-[11px] font-bold text-[#C6FF00] mb-6">
              🎉 7-Day Free Trial
            </div>
            ...
            <div className="space-y-3.5 border-t border-zinc-800/80 pt-6 mb-8">
              {[
                ...
                <div key={feat} className="flex items-start gap-3">
                  <CheckCircle2 size={16} className="text-[#C6FF00] shrink-0 mt-0.5" />
            ...
            <button
              onClick={onStartFree}
              className="w-full py-4 bg-[#C6FF00] hover:opacity-95 active:scale-[0.98] text-black font-black text-xs uppercase tracking-wider rounded-xl transition-all shadow-lg shadow-[#C6FF00]/10"
            >
              Start Free Trial
            </button>
      ...
      <section className="py-16 overflow-hidden">
        <div className="max-w-[480px] mx-auto px-4 mb-8 text-center">
          <span className="font-mono text-[9px] text-[#C6FF00] uppercase tracking-[0.25em] font-bold block mb-1.5">MOMENTUM</span>
      ...
      <section className="px-4 py-20 max-w-[480px] mx-auto w-full text-center relative">
        <div className="absolute inset-0 bg-radial-gradient from-[#C6FF00]/5 via-transparent to-transparent pointer-events-none" />
        ...
        <div className="relative z-10 space-y-6">
          ...
          <button
            onClick={onStartFree}
            className="w-full max-w-[280px] mx-auto py-4.5 bg-[#C6FF00] hover:opacity-95 active:scale-[0.98] text-black font-black text-sm uppercase rounded-xl transition-all flex items-center justify-center gap-2 shadow-xl shadow-[#C6FF00]/15"
          >
            <span>Start Free</span>
            <ArrowRight size={16} strokeWidth={2.5} />
          </button>
