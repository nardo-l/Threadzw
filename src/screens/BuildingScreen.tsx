...
export const BuildingScreen: React.FC<BuildingScreenProps> = ({
  ...
  return (
    <div id="shop-building-screen" className="fixed inset-0 bg-[#0a0a0a] text-white flex flex-col justify-between z-50 font-sans selection:bg-[#25D366]/30 select-none overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 space-y-12">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <motion.div 
            ...
            className="absolute w-32 h-32 rounded-full bg-[#25D366]"
          />
          {/* Spinning dashed circle border */}
          <motion.div 
            animate={{ rotate: 360 }}
            transition={{ repeat: Infinity, duration: 4, ease: "linear" }}
            className="absolute w-28 h-28 rounded-full border-2 border-dashed border-[#25D366]"
          />
          {/* Inner Badge */}
          <div className="relative w-22 h-22 bg-[#121212] border border-white/10 rounded-full flex items-center justify-center text-[#25D366]">
              ...
              return (
                <div key={idx} className="h-6">
                  {visible && (
                    ...
                    >
                      <span className="text-[#25D366] text-lg font-bold">✓</span>
      ...
      <div className="w-full h-[3px] bg-white/5 relative">
        <div 
          ...
          className="h-full bg-[#25D366] transition-all duration-75 ease-out" 
        />
      </div>
