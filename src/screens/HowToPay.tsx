...
export const HowToPay: React.FC<HowToPayProps> = ({ onBack }) => {
  ...
  const handleSupportClick = () => {
    window.open(
      ...
      '?text=' +
      encodeURIComponent(
        'Hi ThreadZW! I paid my $7 subscription but haven\'t received my unlock code yet. My WhatsApp number is: '
      ),
      '_blank'
    );
  };
    ...
    <div className="min-h-screen bg-[#0B0B0B] text-white flex flex-col font-sans">
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-5 pb-24 space-y-4">
        ...
        <div className="bg-[#151515] border border-[#2A2A2A] rounded-[20px] p-5 flex items-center gap-14">
          ...
          <div>
            {/* THREADZW PRICING: $7/month | 28-day trial — do not change without updating all instances */}
            <h2 className="text-white font-bold text-lg">Activate your store — $7/month</h2>
            <p className="text-[#A1A1AA] text-sm mt-1 leading-[1.5]">
              Pay $7/month via EcoCash or InnBucks to keep your shop live.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#151515] border-[1.5px] border-[#C6FF00] rounded-[20px] p-5">
          <div className="flex justify-between items-center">
            <div>
              ...
              <span className="text-white font-bold text-2xl mt-1 block">$7.00 USD</span>
            </div>
          ...
          <div className="bg-[#151515] border border-[#2A2A2A] rounded-2xl p-5 space-y-4">
            ...
            <div className="flex gap-3.5 items-start">
              ...
              <div>
                ...
                <p className="text-[#A1A1AA] text-[13px] mt-1 leading-[1.5]">Type 7 for $7.00 USD</p>
              </div>
            </div>
        ...
        <div className="pt-2">
          ...
          <div className="bg-[#151515] border border-[#2A2A2A] rounded-2xl p-5 space-y-4">
            ...
            <div className="flex gap-3.5 items-start">
              <div className="w-8 h-8 rounded-full bg-[#C6FF00] text-[#0B0B0B] font-bold text-[13px] flex items-center justify-center shrink-0 select-none">5</div>
              <div>
                <h4 className="text-white font-bold text-[14px]">Enter $7 as the amount</h4>
                <p className="text-[#A1A1AA] text-[13px] mt-1 leading-[1.5]">Type 7 for the $7 monthly subscription fee</p>
              </div>
            </div>
