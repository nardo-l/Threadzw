...
export const AuthCallback: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 bg-black">
      <h1 className="text-5xl font-pacifico animate-in fade-in slide-in-from-bottom-4 duration-700 text-[#FF2D78]">thread</h1>
      <div className="flex flex-col items-center gap-4">
        <div className="w-8 h-8 border-4 border-zinc-800 border-t-[#FF2D78] rounded-full animate-spin" />
