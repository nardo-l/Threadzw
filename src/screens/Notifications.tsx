        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-mono tracking-widest text-[#c8ff00] uppercase font-black uppercase">Live Updates</span>
              {unreadCount > 0 && (
        ...
        {notifications.length > 0 && (
          <div className="flex gap-2">
            <button 
              ...
              className="text-[10px] font-black uppercase tracking-wider text-[#c8ff00] hover:underline"
            >
              Read All
            </button>
                ...
                switch (t) {
                  ...
                  case 'request':
                    return {
                      ...
                      color: 'bg-amber-500/10 text-[#c8ff00] border-[#c8ff00]/10'
                    };
                  default:
                    return {
                      icon: <Info size={15} />,
              ...
              return (
                <div 
                  ...
                  className={`bg-white/[0.02] border rounded-2xl p-4 flex gap-4 transition-all ${
                    item.read ? 'border-white/[0.04]' : 'border-[#c8ff00]/20 bg-[#c8ff00]/[0.01]'
                  }`}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <h4 className={`text-[13px] font-extrabold text-white leading-tight ${!item.read ? 'text-[#c8ff00]' : ''}`}>
                        {item.title}
                      </h4>
                      {!item.read && (
                    ...
                    <div className="flex items-center justify-between gap-2 mt-3.5">
                      ...
                      {!item.read && (
                        <button 
                          ...
                          className="flex items-center gap-1.5 text-[9px] font-mono font-bold text-[#c8ff00] uppercase tracking-widest hover:underline"
                        >
                          <Check size={10} />
                          <span>Mark Read</span>
                        </button>
