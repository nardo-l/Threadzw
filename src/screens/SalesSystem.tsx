        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button 
              ...
              className="p-2 border border-zinc-200 rounded-full bg-zinc-50 text-zinc-500 hover:text-zinc-900 transition-colors cursor-pointer"
            >
              <ArrowLeft size={16} />
            </button>
            <div>
              <h1 className="text-lg font-black tracking-tight uppercase leading-none text-zinc-900">Sales Centre</h1>
              <p className="text-xs text-zinc-450 font-extrabold mt-1 uppercase tracking-wide">In-store & CRM Hub</p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            {!isOnline && (
              <span className="bg-amber-50 border border-amber-200 text-amber-700 font-mono text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full flex items-center gap-1">
                <AlertTriangle size={10} /> Local-Only
              </span>
            )}
            {isOnline && (
              <span className="bg-green-50 border border-green-200 text-green-700 font-mono text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full flex items-center gap-1">
            ...
            <button 
              onClick={fetchData} 
              disabled={loading}
              className="p-2 border border-zinc-200 rounded-full bg-zinc-50 text-zinc-400 hover:text-zinc-900 transition-colors cursor-pointer disabled:opacity-35"
            >
              <RefreshCw size={14} className={loading ? 'animate-spin text-zinc-800' : ''} />
            </button>
          </div>
        </div>

        {/* TABS SELECTOR */}
        <div className="flex items-center border border-zinc-150 bg-zinc-100 rounded-xl p-1 mt-5 gap-1.5 overflow-x-auto no-scrollbar">
          {[
