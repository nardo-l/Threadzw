          ...
          {hasLocationInfo && (
            <div className="flex-grow flex justify-center items-center h-full relative">
              <button
                ...
                className="absolute -top-7 w-[60px] h-[60px] rounded-full bg-green-600 hover:bg-green-700 text-white flex flex-col items-center justify-center shadow-lg hover:shadow-xl transition-all border-4 border-white cursor-pointer scale-100 hover:scale-105"
                title="Visit Shop"
              >
                <MapPin className="w-5 h-5 mb-0.5" />
                <span className="text-[7.5px] font-extrabold uppercase tracking-widest leading-none">Visit Shop</span>
              </button>
            </div>
          )}
