  ...
  return (
    <div className="flex flex-col bg-black min-h-screen text-white">
      ...
      <div className="px-5 py-6">
        {/* Info Card */}
        <div className="rounded-[16px] bg-linear-to-br from-[#9B27AF] to-[#C6FF00] p-5 mb-8">
        ...
        <div className="space-y-6">
           <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center bg-[#1a1a1a] border border-[#333] rounded-[10px] h-12 focus-within:border-[#C6FF00] transition-colors overflow-hidden">
           ...
           <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                className="w-full h-12 bg-[#1a1a1a] border border-[#333] rounded-[10px] px-4 text-white text-[14px] focus:outline-none focus:border-[#C6FF00] transition-colors"
              />
           </div>
                 ...
                 {checklistItems.map((item, i) => (
                    <div key={`entry-check-${i}`} className="flex gap-3 items-start" onClick={() => toggleCheck(i)}>
                       <div className={`w-6 h-6 rounded-[6px] shrink-0 border-2 transition-all flex items-center justify-center
                         ${checks[i] ? 'bg-linear-to-br from-[#9B27AF] to-[#C6FF00] border-transparent' : 'bg-[#1a1a1a] border-[#333]'}`}>
        ...
        <button 
          ...
          className={`mt-10 w-full h-[56px] rounded-full font-bold text-[15px] flex items-center justify-center transition-all shadow-lg
            ${isComplete && !loading ? 'bg-linear-to-r from-[#9B27AF] to-[#C6FF00] text-white active:scale-[0.98]' : 'bg-[#333] text-[#666]'}`}
        >
        ...
        {success && (
          <>
            ...
            >
               ...
               <div className="w-14 h-14 bg-linear-to-br from-[#9B27AF] to-[#C6FF00] rounded-full flex items-center justify-center mb-6">
               ...
               <button 
                 onClick={() => { setSuccess(false); setBuyerFlowState('bestDresser'); }}
                 className="mt-10 w-full h-[52px] bg-linear-to-r from-[#9B27AF] to-[#C6FF00] rounded-full text-white font-bold text-[15px]"
               >
                 Got It
               </button>
            </motion.div>
