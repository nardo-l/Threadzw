      ...
      <div className="flex-1 flex flex-col pt-14 pb-12">
        ...
        >
          ...
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[42px] font-black font-bebas tracking-tight bg-linear-to-br from-[#9B27AF] to-[#C6FF00] bg-clip-text text-transparent italic">
              {result.name}
            </span>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="mt-8 px-6"
        >
          <span className="text-[#C6FF00] text-[40px] font-serif leading-[0.6] block mb-1.5">"</span>
        ...
        >
          <div className="flex gap-2.5">
            <button 
              onClick={handleShare}
              className="flex-1 h-[52px] bg-linear-to-r from-[#9B27AF] to-[#C6FF00] rounded-[12px] text-white font-bold text-[14px] flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
            >
              Share 📸
            </button>
            <button 
          ...
          <div className="flex flex-col items-center gap-2 mt-3 text-center">
            <button 
              ...
              className="text-[#C6FF00] text-[13px] font-medium flex items-center gap-1.5"
            >
