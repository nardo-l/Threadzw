...
import { Users, MapPin, MessageCircle, Radio } from 'lucide-react';
...
export const CommunityPageView: React.FC<CommunityPageViewProps> = ({ page }) => {
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col items-center justify-center p-4 sm:p-6 font-sans">
      <div className="w-full max-w-md bg-[#141414] border border-zinc-800 rounded-2xl p-6 shadow-2xl flex flex-col items-center text-center space-y-6">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-amber-400 font-medium uppercase tracking-wider">{page.category || 'Organization / Community'}</p>
        </div>
        ...
        <div className="w-full p-4 rounded-xl bg-zinc-900/90 border border-zinc-800/90 text-left space-y-2">
          <div className="flex items-center justify-between text-xs font-semibold text-zinc-300">
            <span>Community Hub & Events</span>
          ...
          <p className="text-xs text-zinc-400 leading-normal">
            Community announcements, event schedules, and group join links will be available in Phase 3.
          </p>
        </div>
