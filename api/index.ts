...
// NOTE: The legacy billing router was removed from the repository, so importing it here
// caused the entire Vercel serverless bundle to fail before any API route could run.
...
// Global Express error handler. Always return JSON so clients do not try to parse
// a Vercel/Express HTML error page as JSON.
